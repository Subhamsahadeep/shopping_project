			...
			<div class="panel panel-primary">
			  ...
			  <form method="post" >
					...
					<div class="col-md-12">
							...
							<input type="text" id="email" name="email" class="form-control" autocomplete="on" required>
					</div>
						</div>
				  ...
				  <div class="row">
					...
					<div class="row">
						<div class="col-md-12">
							<center><input value="Submit" type="button" id="pnbtn" name="pnbutton" class="btn btn-success btn-lg">
						</center></div>
					</div>
				  </div>
			  </form>
